        ...
        public static void Seed(PublicSportDataContext context)
        {
            try
            {
                ...
                context.RugbyLogGroups.AddOrUpdate(
                    ...
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 0, IsConference = false, Slug = SlugHierarchyLevel0Overall, ProviderLogGroupId = 0, ProviderGroupName = null, GroupName = "Overall Standings", GroupShortName = "Overall Standings", IsCoreGroup = true },
                    // LogGroups for "SecondaryGroupStandings", GroupHierarchyLevel: 1.
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 1, IsConference = false, Slug = SlugHierarchyLevel1Australasian, ProviderLogGroupId = 3, ProviderGroupName = "Australasian Conference", GroupName = "Australasian Group", GroupShortName = "Aus/NZ Group", IsCoreGroup = true },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 1, IsConference = false, Slug = SlugHierarchyLevel1SouthAfrican, ProviderLogGroupId = 4, ProviderGroupName = "South African Conference", GroupName = "South African Group", GroupShortName = "Africa Group", IsCoreGroup = true },
                    // LogGroups for "GroupStandings", GroupHierarchyLevel: 2.
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = true, Slug = SlugHierarchyLevel2Australian, ProviderLogGroupId = 1, ProviderGroupName = "Australian Conference", GroupName = "Australian Conference", GroupShortName = "Aus Conference", IsCoreGroup = true },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = true, Slug = SlugHierarchyLevel2Zealand, ProviderLogGroupId = 2, ProviderGroupName = "New Zealand Conference", GroupName = "New Zealand Conference", GroupShortName = "NZ Conference", IsCoreGroup = true },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = true, Slug = SlugHierarchyLevel2Africa1, ProviderLogGroupId = 3, ProviderGroupName = "Africa 1 Conference", GroupName = "Africa Conference 1", GroupShortName = "Africa Con 1", IsCoreGroup = true },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = true, Slug = SlugHierarchyLevel2Africa2, ProviderLogGroupId = 4, ProviderGroupName = "Africa 2 Conference", GroupName = "Africa Conference 2", GroupShortName = "Africa Con 2", IsCoreGroup = true }
                );
