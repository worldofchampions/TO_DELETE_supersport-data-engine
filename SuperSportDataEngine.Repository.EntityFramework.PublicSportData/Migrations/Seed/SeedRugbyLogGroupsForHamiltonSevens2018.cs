        ...
        public static void Seed(PublicSportDataContext context)
        {
            try
            {
                ...
                context.RugbyLogGroups.AddOrUpdate(
                    ...
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = false, IsCoreGroup = true, Slug = SlugHierachyLevel2HamiltonSevens2018PoolA, ProviderLogGroupId = 1, ProviderGroupName = "Hamilton 2018 Group A", GroupName = "Hamilton 2018 Group A", GroupShortName = "Hamilton 2018 Group A" },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = false, IsCoreGroup = true, Slug = SlugHierachyLevel2HamiltonSevens2018PoolB, ProviderLogGroupId = 2, ProviderGroupName = "Hamilton 2018 Group B", GroupName = "Hamilton 2018 Group B", GroupShortName = "Hamilton 2018 Group B" },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = false, IsCoreGroup = true, Slug = SlugHierachyLevel2HamiltonSevens2018PoolC, ProviderLogGroupId = 3, ProviderGroupName = "Hamilton 2018 Group C", GroupName = "Hamilton 2018 Group C", GroupShortName = "Hamilton 2018 Group C" },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = false, IsCoreGroup = true, Slug = SlugHierachyLevel2HamiltonSevens2018PoolD, ProviderLogGroupId = 4, ProviderGroupName = "Hamilton 2018 Group D", GroupName = "Hamilton 2018 Group D", GroupShortName = "Hamilton 2018 Group D" }
                );
