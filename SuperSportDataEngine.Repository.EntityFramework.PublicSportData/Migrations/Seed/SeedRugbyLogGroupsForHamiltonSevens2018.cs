        ...
        public static void Seed(PublicSportDataContext context)
        {
            try
            {
                ...
                context.RugbyLogGroups.AddOrUpdate(
                    ...
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = false, IsCoreGroup = false, Slug = SlugHierachyLevel2HamiltonSevens2018PoolA, ProviderLogGroupId = 1, ProviderGroupName = "Hamilton 2018 Group A", GroupName = "Pool A", GroupShortName = "Pool A" },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = false, IsCoreGroup = false, Slug = SlugHierachyLevel2HamiltonSevens2018PoolB, ProviderLogGroupId = 2, ProviderGroupName = "Hamilton 2018 Group B", GroupName = "Pool B", GroupShortName = "Pool B" },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = false, IsCoreGroup = false, Slug = SlugHierachyLevel2HamiltonSevens2018PoolC, ProviderLogGroupId = 3, ProviderGroupName = "Hamilton 2018 Group C", GroupName = "Pool C", GroupShortName = "Pool C" },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = false, IsCoreGroup = false, Slug = SlugHierachyLevel2HamiltonSevens2018PoolD, ProviderLogGroupId = 4, ProviderGroupName = "Hamilton 2018 Group D", GroupName = "Pool D", GroupShortName = "Pool D" }
                );
