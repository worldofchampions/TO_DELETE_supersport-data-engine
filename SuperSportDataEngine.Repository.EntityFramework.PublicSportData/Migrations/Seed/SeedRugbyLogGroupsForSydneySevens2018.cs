        ...
        public static void Seed(PublicSportDataContext context)
        {
            try
            {
                ...
                context.RugbyLogGroups.AddOrUpdate(
                    ...
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = false, IsCoreGroup = false, Slug = SlugHierachyLevel2SydneySevens2018PoolA, ProviderLogGroupId = 1, ProviderGroupName = "Sydney 2018 Group A", GroupName = "Sydney 2018 Group A", GroupShortName = "Sydney 2018 Group A" },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = false, IsCoreGroup = false, Slug = SlugHierachyLevel2SydneySevens2018PoolB, ProviderLogGroupId = 2, ProviderGroupName = "Sydney 2018 Group B", GroupName = "Sydney 2018 Group B", GroupShortName = "Sydney 2018 Group B" },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = false, IsCoreGroup = false, Slug = SlugHierachyLevel2SydneySevens2018PoolC, ProviderLogGroupId = 3, ProviderGroupName = "Sydney 2018 Group C", GroupName = "Sydney 2018 Group C", GroupShortName = "Sydney 2018 Group C" },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = false, IsCoreGroup = false, Slug = SlugHierachyLevel2SydneySevens2018PoolD, ProviderLogGroupId = 4, ProviderGroupName = "Sydney 2018 Group D", GroupName = "Sydney 2018 Group D", GroupShortName = "Sydney 2018 Group D" }
                );
