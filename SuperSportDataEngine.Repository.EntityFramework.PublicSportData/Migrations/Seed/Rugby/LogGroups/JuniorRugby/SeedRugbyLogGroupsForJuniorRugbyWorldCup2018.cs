...
namespace SuperSportDataEngine.Repository.EntityFramework.PublicSportData.Migrations.Seed.Rugby.LogGroups.JuniorRugby
{
    ...
    {
        private const string SlugHierarchyLevel0JuniorRugby = "JuniorRugbyWorldCup-2018-HL0-JuniorRugby";
        private const string SlugHierarchyLevel1PoolA = "JuniorRugbyWorldCup-2018-HL1-PoolA";
        private const string SlugHierarchyLevel1PoolB = "JuniorRugbyWorldCup-2018-HL1-PoolB";
        private const string SlugHierarchyLevel1PoolC = "JuniorRugbyWorldCup-2018-HL1-PoolC";
