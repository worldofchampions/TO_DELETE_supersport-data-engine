...
namespace SuperSportDataEngine.Repository.EntityFramework.PublicSportData.Migrations.Seed.Rugby.LogGroups.ChampionsCup
{
    ...
    {
        private const string SlugHierarchyLevel0ChampionsCup = "ChampionsCup-2018-HL0-ChampionsCup";
        private const string SlugHierarchyLevel1Pool1 = "ChampionsCup-2018-HL1-Pool1";
        private const string SlugHierarchyLevel1Pool2 = "ChampionsCup-2018-HL1-Pool2";
        private const string SlugHierarchyLevel1Pool3 = "ChampionsCup-2018-HL1-Pool3";
        private const string SlugHierarchyLevel1Pool4 = "ChampionsCup-2018-HL1-Pool4";
        private const string SlugHierarchyLevel1Pool5 = "ChampionsCup-2018-HL1-Pool5";
