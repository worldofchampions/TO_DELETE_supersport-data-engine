        ...
        public static void Seed(PublicSportDataContext context)
        {
            try
            {
                ...
                context.RugbyLogGroups.AddOrUpdate(
                    ...
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 1, IsConference = true, IsCoreGroup = true, Slug = SlugHierachyLevel1SingaporeSevens2018, ProviderLogGroupId = 0, ProviderGroupName = "Singapore 2018", GroupName = "Singapore 2018", GroupShortName = "Singapore 2018" },
