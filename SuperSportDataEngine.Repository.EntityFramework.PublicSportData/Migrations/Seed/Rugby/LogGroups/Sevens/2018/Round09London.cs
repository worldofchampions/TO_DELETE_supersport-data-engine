    ...
    public static class Round09London
    {
        ...
        public static void Seed(PublicSportDataContext context)
        {
            try
            {
                ...
                context.RugbyLogGroups.Single(x => x.Slug == SlugHierarchyLevel2LondonSevens2018).ParentRugbyLogGroup = context.RugbyLogGroups.Single(x => x.Slug == Round03Sydney.SlugHierarchyLevel1Sevens2018Rounds);
