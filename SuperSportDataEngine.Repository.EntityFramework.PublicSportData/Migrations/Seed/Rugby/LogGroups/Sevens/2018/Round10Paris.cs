        ...
        public static void Seed(PublicSportDataContext context)
        {
            try
            {
                ...
                context.RugbyLogGroups.AddOrUpdate(
                    ...
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 1, IsConference = true, IsCoreGroup = true, Slug = SlugHierachyLevel1ParisSevens2018, ProviderLogGroupId = null, ProviderGroupName = "Paris 2018", GroupName = "Paris 2018", GroupShortName = "Paris 2018" },
