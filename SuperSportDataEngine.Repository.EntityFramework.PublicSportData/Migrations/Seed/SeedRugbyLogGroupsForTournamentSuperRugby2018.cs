        ...
        public static void Seed(PublicSportDataContext context)
        {
            try
            {
                ...
                context.RugbyLogGroups.AddOrUpdate(
                    ...
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 2, IsConference = false, IsCoreGroup = true, Slug = SlugHierarchyLevel1SouthAfrican, ProviderLogGroupId = 3, ProviderGroupName = "South African Conference", GroupName = "South African Conference", GroupShortName = "Africa Group" }
                );
