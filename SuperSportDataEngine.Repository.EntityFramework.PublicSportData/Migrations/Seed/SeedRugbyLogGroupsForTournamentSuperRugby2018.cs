        ...
        public static void Seed(PublicSportDataContext context)
        {
            try
            {
                ...
                context.RugbyLogGroups.AddOrUpdate(
                    ...
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 1, IsConference = true, IsCoreGroup = true, Slug = SlugHierarchyLevel1Australian, ProviderLogGroupId = 1, ProviderGroupName = "Australian Conference", GroupName = "Australian Conference", GroupShortName = "Aus Group" },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 1, IsConference = true, IsCoreGroup = true, Slug = SlugHierarchyLevel1NewZealand, ProviderLogGroupId = 2, ProviderGroupName = "New Zealand Conference", GroupName = "New Zealand Conference", GroupShortName = "NZ Group" },
                    new RugbyLogGroup { DataProvider = DataProvider.StatsProzone, RugbySeason = rugbySeason, GroupHierarchyLevel = 1, IsConference = true, IsCoreGroup = true, Slug = SlugHierarchyLevel1SouthAfrican, ProviderLogGroupId = 3, ProviderGroupName = "South African Conference", GroupName = "South African Conference", GroupShortName = "Africa Group" }
                );
