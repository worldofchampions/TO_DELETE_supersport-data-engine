...
{
    [TestFixture]
    public class TennisRankingsManagerJobTests
    {
        ...
        private TennisRankingsManagerJob CreateTennisRankingsManagerJob()
        {
            return new TennisRankingsManagerJob(
        ...
        {
            // Arrange
            var unitUnderTest = CreateTennisRankingsManagerJob();
        ...
        [Test]
        public async Task CreateRankRankingsJob_EventCurrent()
        {
            // Arrange
            var unitUnderTest = CreateTennisRankingsManagerJob();
            ...
            _mockRecurringJobManager
                .Verify(
                    m => m.AddOrUpdate(
                        "Tennis→Stats→ChildJob→Rankings→" + "test",
                        It.IsAny<Job>(),
                        "0 */1 * * *",
        ...
        [Test]
        public async Task CreateRaceRankingsJob_EventCurrent()
        {
            // Arrange
            var unitUnderTest = CreateTennisRankingsManagerJob();
            Setup_CurrentEventInRepository();
            ...
            _mockRecurringJobManager
                .Verify(
                    m => m.AddOrUpdate(
                        "Tennis→Stats→ChildJob→RaceRankings→" + "test",
                        It.IsAny<Job>(),
                        "0 */1 * * *",
                        It.IsAny<RecurringJobOptions>()),
                    Times.Exactly(1));
        ...
        [Test]
        public async Task DontCreateAnyRankingsJobs_EventEnded()
        {
            // Arrange
            var unitUnderTest = CreateTennisRankingsManagerJob();
        ...
        [Test]
        public async Task DontCreateAnyRankingsJobs_EventFuture()
        {
            // Arrange
            var unitUnderTest = CreateTennisRankingsManagerJob();
        ...
        [Test]
        public async Task DeleteRankRankingsJobs_EventEnded()
        {
            // Arrange
            var unitUnderTest = CreateTennisRankingsManagerJob();
            Setup_EndedEventInRepository();
        ...
        [Test]
        public async Task DeleteRaceRankingsJobs_EventEnded()
        {
            // Arrange
            var unitUnderTest = CreateTennisRankingsManagerJob();
            Setup_EndedEventInRepository();
        ...
        [Test]
        public async Task DontDeleteRaceRankingsJobs_EventFuture()
        {
            // Arrange
            var unitUnderTest = CreateTennisRankingsManagerJob();
            Setup_FutureEventInRepository();
        ...
        [Test]
        public async Task DontDeleteRaceRankingsJobs_EventCurrent()
        {
            // Arrange
            var unitUnderTest = CreateTennisRankingsManagerJob();
            Setup_CurrentEventInRepository();
