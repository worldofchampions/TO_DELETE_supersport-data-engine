...
namespace SuperSportDataEngine.ApplicationLogic.Boundaries.Gateway.Http.StatsProzone.Models
{
    public class GameInfo
    {
        ...
        public int videoReferee1Id { get; set; }
        public string videoReferee1Name { get; set; }
    ...
    {
        public List<object> inOut { get; set; }
    }
    ...
    public class Period
    {
        ...
        public List<PeriodStat> periodStat { get; set; }
    }
    ...
    {
        public List<MatchStat> matchStat { get; set; }
    }
    ...
    {
        public int periodId { get; set; }
        public List<PeriodStat2> periodStat { get; set; }
    }
    ...
    {
        public List<MatchStat2> matchStat { get; set; }
    }
