...
namespace SuperSportDataEngine.ApplicationLogic.Services
{
    ...
    public class RugbyIngestWorkerService : IRugbyIngestWorkerService
    {
        ...
        {
            if (entitiesResponse.Entities.players == null)
                return;
        ...
        private async Task PersistFlatLogs(CancellationToken cancellationToken, RugbyFlatLogsResponse flatLogsResponse)
        {
            ...
            var laddersAlreadyInDb = (await _publicSportDataUnitOfWork.RugbyFlatLogs.AllAsync()).ToList();
        ...
        {
            if (entitiesResponse.Entities.competitions == null)
                return;
