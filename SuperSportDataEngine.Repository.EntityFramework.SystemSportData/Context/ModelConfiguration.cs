namespace SuperSportDataEngine.Repository.EntityFramework.SystemSportData.Context
{
    ...
    internal static class ModelConfiguration
    {
        ...
        {
            modelBuilder.Entity<SchedulerTrackingRugbyFixture>()
                .HasKey(x => new { x.FixtureId, x.TournamentId });

            modelBuilder.Entity<SchedulerTrackingRugbyTournament>()
                .HasKey(x => new { x.TournamentId, x.SeasonId });
